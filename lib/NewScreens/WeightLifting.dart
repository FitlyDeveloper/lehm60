            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 20), // Gap after gray line
                    // Quick Start Section
                    Text(
                      'Quick Start',
                      style: TextStyle(
                    ...
                    SizedBox(height: 15), // Gap between title and cube
                    ...
                    SizedBox(height: 20), // Gap between sectors
                    // Routines Section
                    Text(
                      'Routines',
                      style: TextStyle(
                    ...
                    SizedBox(height: 15), // Gap between title and cubes
                    // Routines Row
                    Row(
                      children: [
                        Expanded(
                        ...
                        SizedBox(width: 15), // Gap between same sector cubes
                        Expanded(
                          child: Container(
                            height: 90,
                            decoration: BoxDecoration(
                    ...
                    SizedBox(height: 15), // Gap between cubes and dropdown
                    // My Routines Button
                    Align(
                    ...
                    // Push Section - Only show when expanded
