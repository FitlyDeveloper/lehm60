...
class _CodiaPage extends State<CodiaPage> {
  ...
  Widget build(BuildContext context) {
    final filteredExercises = _searchQuery.isEmpty
        ? exercises
        : exercises.where((ex) => ex.name.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
    return Container(
      color: Colors.white,
      child: SizedBox(
        width: 393,
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              top: 0,
              height: 852,
              child: Image.asset('assets/images/background4.jpg', width: 393, height: 852, fit: BoxFit.cover,),
            ),
            Positioned(
              left: 0,
              right: 0,
              ...
              child: SafeArea(
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 29, vertical: 8.5),
                      child: Stack(
                        children: [
                          Center(
                            child: Text(
              ...
              child: Material(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: const [BoxShadow(color: Color(0x14000000), offset: Offset(0, 3), blurRadius: 8)],
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    ...
                    children: [
                      ...
                      Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) => Icon(Icons.search, color: Colors.grey.withOpacity(0.5), size: 18),
                      ),
                      SizedBox(width: 8),
                      Expanded(
                        child: TextField(
            ...
            Positioned(
              ...
              child: Text(
                ...
                style: TextStyle(decoration: TextDecoration.none, fontSize: 17, color: const Color(0x7f000000), fontFamily: 'SFProDisplay-Regular', fontWeight: FontWeight.normal),
                maxLines: 9999,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              height: 48,
                              decoration: BoxDecoration(
                                color: isSelected ? Colors.white.withOpacity(0.15) : Colors.grey[300],
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 13,
                                      color: isSelected ? Colors.white70 : Color(0x7f000000),
                                      fontFamily: 'SFProDisplay-Regular',
                                      fontWeight: FontWeight.normal,
                                      decoration: TextDecoration.none,
                                    ),
...
final List<Exercise> exercises = [
  Exercise(name: 'Bench Press (Barbell)', muscle: 'Chest', equipment: 'Barbell'),
  Exercise(name: 'Dumbbell Chest Press', muscle: 'Chest', equipment: 'Dumbbell'),
  Exercise(name: 'Incline Bench Press (Barbell)', muscle: 'Chest', equipment: 'Barbell'),
  Exercise(name: 'Incline Dumbbell Press', muscle: 'Chest', equipment: 'Dumbbell'),
  ...
  Exercise(name: 'Bulgarian Split Squat', muscle: 'Legs', equipment: 'Dumbbell'),
  ...
  Exercise(name: 'Dumbbell Shoulder Press', muscle: 'Shoulders', equipment: 'Dumbbell'),
  ...
  Exercise(name: 'Overhead Tricep Extension', muscle: 'Arms', equipment: 'Dumbbell'),
  Exercise(name: 'Close-Grip Bench Press', muscle: 'Arms', equipment: 'Barbell'),
  Exercise(name: 'Rope Overhead Tricep Extension', muscle: 'Arms', equipment: 'Cable'),
